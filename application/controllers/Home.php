            ...
            if (!demo()) {
                ...
                if ($prev_password == $current_password) {
                    if ($new_password == $current_password) {
                        $ajax_error[] = array('ajax_error'  =>  "<p class='text-danger'>" . translate('new_password_and_current_password_are_same') . "!</p>");
                        echo json_encode($ajax_error);
                    }
                    if ($new_password == $confirm_password) {
                        ...
                        $ajax_error[] = array('ajax_error'  =>  "<p class='text-danger'>" . translate('new_password_does_not_matched_with_confirm_password') . "!</p>");
                        echo json_encode($ajax_error);
                    }
                } else {
                    $ajax_error[] = array('ajax_error'  =>  "<p class='text-danger'>" . translate('invalid_current_password') . "!</p>");
                    echo json_encode($ajax_error);
                }
            }
