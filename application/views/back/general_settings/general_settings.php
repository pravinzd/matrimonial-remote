...
<form class="form-horizontal" id="general_settings_form" method="POST" action="<?= base_url() ?>admin/general_settings/update_general_settings">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label" for="email_verification"><b><?php echo translate('users_need_to_login_to_view_member_profile_picture') ?></b></label>
		<div class="col-sm-7">
			<select name="blur_member_profile_image" class="form-control">
				<?php $blur_member_profile_image = $this->db->get_where('general_settings', array('type' => 'blur_member_profile_image'))->row()->value; ?>
				<option value="yes" <?php if ($blur_member_profile_image == 'yes') echo 'selected'; ?>><?php echo translate('yes') ?> </option>
				<option value="no" <?php if ($blur_member_profile_image == 'no') echo 'selected'; ?>><?php echo translate('no') ?> </option>
			</select>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 control-label" for="email_verification"><b><?php echo translate('member_name_show_on_accept_interest') ?></b></label>
		<div class="col-sm-7">
			<select name="member_name_show_on_accept_interest" class="form-control">
				<?php $member_name_show_on_accept_interest = $this->db->get_where('general_settings', array('type' => 'member_name_show_on_accept_interest'))->row()->value; ?>
				<option value="yes" <?php if ($member_name_show_on_accept_interest == 'yes') echo 'selected'; ?>><?php echo translate('yes') ?> </option>
				<option value="no" <?php if ($member_name_show_on_accept_interest == 'no') echo 'selected'; ?>><?php echo translate('no') ?> </option>
			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-2 control-label text-start">
