...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow"><?php echo translate('edit_role') ?></h1>
			<!--Searchbox-->
			<div class="searchbox">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><?php echo translate('edit_role') ?></li>
		</ol>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<!--End breadcrumb-->
	</div>
	<div id="page-content">
		<div class="panel">
			...
			<div class="panel-body">
				...
				?>
					<form class="form-horizontal" id="manage_details_form" method="POST" action="<?= base_url() ?>admin/role/update/<?= $row['role_id'] ?>">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" value="<?php if (!empty($form_contents)) {
																					...
																					echo $row['name'];
																				} ?>" name="name" placeholder="<?= translate('role_name') ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="description"><b><?= translate('description') ?> </span></b></label>
							<div class="col-sm-8">
								<textarea name="description" class="form-control" placeholder="<?php echo translate('role_description'); ?>"><?php if (!empty($form_contents)) {
							...
							<div class="col-sm-8">
								<table class="table table-condensed">
									...
									?>
										<tr>
											<td>
												<?php echo translate($row1['codename']); ?>
											</td>
											<td>
												<div class="checkbox">
													<input id="per_<?php echo $row1['permission_id']; ?>" name="permission[]" value="<?php echo $row1['permission_id']; ?>" data-id='<?php echo $row1['permission_id']; ?>' class="magic-checkbox" type="checkbox" <?php
																																																																	if (in_array($row1['permission_id'], $permission)) {
																																																																		echo 'checked';
																																																																	}
																																																																	?>>
