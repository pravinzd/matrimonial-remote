							...
							<div class="panel-body">
								...
								<form class="form-horizontal" id="paypal_settings_form" method="POST" action="<?= base_url() ?>admin/update_currency_settings/currency_format">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<?php
											$symbol_formats = array(
												's_amount' => '{{ Symbol }} {{ Amount }}',
											...
											<select class="form-control chosen" name="symbol_format">
												...
												?>
													<option value="<?php echo $n; ?>" <?php if ($n == $symbol_format) {
																							echo 'selected';
																						} ?>>
														<?php echo $row; ?>
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<select class="form-control chosen" name="no_of_decimals">
												...
												?>
													<option value="<?php echo $n; ?>" <?php if ($n == $no_of_decimal) {
																							echo 'selected';
																						} ?>>
														<?php echo $row; ?>
													</option>
