							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control" name="type">
										<option class="form-control" value="test" <?php if ($this->db->get_where('third_party_settings', array('type' => 'msg91_type'))->row()->value == "test") {
																						echo "selected";
																					} ?>><?= translate('test') ?></option>
										<option class="form-control" value="original" <?php if ($this->db->get_where('third_party_settings', array('type' => 'msg91_type'))->row()->value == "original") {
																							echo "selected";
																						} ?>><?= translate('original') ?></option>
