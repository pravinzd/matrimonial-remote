					...
					<div class="col-md-8 col-md-offset-2">
						<form class="form-horizontal" id="profile_sections_settings_form" method="POST" action="<?= base_url() ?>admin/update_profile_sections_settings">
							<div class="form-group">
								...
								<label class="col-sm-3 control-label text-start" for="present_address_status"><b><?= translate('present_address') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="education_and_career_status"><b><?= translate('education_and_career') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="physical_attributes_status"><b><?= translate('physical_attributes') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="language_status"><b><?= translate('language') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="hobbies_and_interests_status"><b><?= translate('hobbies_and_interests') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="personal_attitude_and_behavior_status"><b><?= translate('personal_attitude_and_behavior') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="residency_information_status"><b><?= translate('residency_information') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="spiritual_and_social_background_status"><b><?= translate('spiritual_and_social_background') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="life_style_status"><b><?= translate('life_style') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="astronomic_information_status"><b><?= translate('astronomic_information') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="permanent_address_status"><b><?= translate('permanent_address') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="family_information_status"><b><?= translate('family_information') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="additional_personal_details_status"><b><?= translate('additional_personal_details') ?></b></label>
							</div>
							<div class="form-group">
								<div class="col-sm-3 text-end">
									<div class="checkbox">
								...
								<label class="col-sm-3 control-label text-start" for="partner_expectation_status"><b><?= translate('partner_expectation') ?></b></label>
							</div>

							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-8 text-end">
