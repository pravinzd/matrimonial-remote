		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<a class="btn btn-sm btn-primary btn-dark" target="_blank" download href="<?php echo base_url() . "uploads/bulk_skeletons/member.xlsx" ?>"><?php echo translate('Download member bulk add skeleton file'); ?></a>
					<a class="btn btn-sm btn-primary" target="_blank" download href="<?php echo base_url() . "uploads/bulk_skeletons/member_example.xlsx" ?>"><?php echo translate('Download member bulk add example file'); ?></a>
				</div>
			</div>
			<div class="panel-body">
				<div class="text-start">
				...
				<div class="form-group">
					<button data-target="#on_behalf_ids" type="button" class="btn btn-primary" data-toggle="modal"><?php echo translate("On Behalf") ?></button>
					<button data-target="#package_ids" type="button" class="btn btn-primary" data-toggle="modal"><?php echo translate("Package") ?></button>
				</div>
			</div>
