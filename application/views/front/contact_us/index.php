<section class="slice sct-color-1">
    <?php if (!empty($success_alert)) : ?>
        <div class="col-6 ms-auto  me-auto" id="success_alert">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="name" class="form-control form-control-md" required="" value="<?php if (!empty($form_contents)) {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                ...
                                <input type="email" name="email" class="form-control form-control-md" required="" value="<?php if (!empty($form_contents)) {
                        ...
                        <div class="col-sm-6">
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="subject" class="form-control form-control-md" required="" value="<?php if (!empty($form_contents)) {
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group has-feedback">
                                ...
                                <textarea name="message" class="form-control no-resize" rows="5" required="" maxlength="300"><?php if (!empty($form_contents)) {
