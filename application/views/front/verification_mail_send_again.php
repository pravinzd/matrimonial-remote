...
<body>
    ...
    <?php if ($member_approval == 'yes') { ?>
        <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?= base_url() ?>uploads/registration_message_image/<?= $registration_message_image_data[0]['image'] ?>); background-position: center bottom;">
        <?php } else { ?>
