    ...
    <div class="block block--style-3 list z-depth-1-top" id="block_<?=$member->member_id?>">
            ...
            <a onclick="return goto_profile(<?=$member->member_id?>)">
                <?php
                    ...
                    <?php
                        ...
                        ?>
                          <div class="listing-image <?php if($image_blur != null) echo $image_blur ?>" style="background-image: url(<?=base_url()?>uploads/profile_image/<?=$image[0]['profile_image']?>)"></div>
                      <?php }
                      else{ ?>
                          <div class="listing-image" style="background-image: url(<?=base_url()?>uploads/profile_image/default.jpg"></div>
                      <?php }
        ...
        <div class="block-title-wrapper">
            ...
            <h3 class="heading heading-5 strong-500 <?php if($member->membership == 1){echo 'mt-4';} else {echo'mt-1';}?>">
              <?php
                ...
                if ($member_name_show_on_accept_interest == 'yes'){
                  if(!empty($this->session->userdata('member_id'))){
                    $name_show =  interest_status_check($member->member_id, $check_interest);
                  }
                  else{
                    $name_show = false;
                  }
              ...
              ?>
              <a onclick="return goto_profile(<?=$member->member_id?>)" class="c-base-1">
                <?php if($name_show){
                  echo $member->first_name." ".$member->last_name;
                 }
                else{
                  echo translate('ID').' - '.$member->member_profile_id;
                 }
                ?>
              </a>
            </h3>
            ...
            <table class="table-striped table-bordered mb-2" style="font-size: 12px;">
                <tr>
                    ...
                    <td height="30" style="padding-left: 5px;" class="font-dark" colspan="3">
                      <a onclick="return goto_profile(<?=$member->member_id?>)" class="c-base-1"><b><?=$member->member_profile_id?></b></a></td>
                </tr>
                <tr>
