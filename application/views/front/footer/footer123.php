                                            ...
                                            <div class="col-md-3 col-lg-3">
                                                <div class="col">
                                                    <a class="navbar-brand" href="#">
                                                        ...
                                                        ?>
                                                            <img src="<?= base_url() ?>uploads/footer_logo/<?= $footer_logo[0]['image'] ?>" class="img-responsive w-100" alt="footer_logo">
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <img src="<?= base_url() ?>uploads/footer_logo/default_image.png" class="img-responsive w-100" alt="footer_logo">
                                                        <?php
                                                        }
                                                        ?>
                                                    </a>
                                            ...
                                            <div class="col-md-3 col-lg-3">
                                                <div class="col">
                                                    <a class="navbar-brand" href="#">
                                                        ...
                                                        if (file_exists('uploads/footer_logo/' . $footer_logo[0]['image'])) {
                                                        ?>
                                                            <img src="<?= base_url() ?>uploads/footer_logo/<?= $footer_logo[0]['image'] ?>" class="img-responsive w-100">
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <img src="<?= base_url() ?>uploads/footer_logo/default_image.png" class="img-responsive w-100">
                                                        <?php
                                                        }
                                                        ?>
                                                    </a>
                        ...
                        <div>
                            ...
                            <!-- sleeping-line -->
                            <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-8134997030999128" data-ad-slot="6627556491" data-ad-format="auto" data-full-width-responsive="true"></ins>
                            <script>
