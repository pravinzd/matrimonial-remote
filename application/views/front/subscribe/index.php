...
?>
<section class="slice sct-color-1 pricing-plans pricing-plans--style-1 has-bg-cover bg-size-cover" style="background-image: url(<?= base_url() ?>uploads/premium_plans_image/<?= $background_image_data[0]['image'] ?>); background-position: center bottom;">
    <div class="container">
        <span class="clearfix"></span>
        <div class="row">
            <?php foreach ($selected_plan as $value) : ?>
                <div class="col-sm-8 col-md-4 ms-auto  me-auto">
