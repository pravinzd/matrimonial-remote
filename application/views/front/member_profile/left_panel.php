    ...
    <div class="sidebar-object mb-0">
        ...
        <div class="profile-details">
            <h2 class="heading heading-3 strong-500 profile-name">
                <?php if ($name_show) {
                    echo $get_member[0]->first_name . " " . $get_member[0]->last_name;
                } else {
                    echo translate('ID') . ' - ' . $get_member[0]->member_profile_id;
                }
                ?>
            </h2>
            ...
            <div class="profile-connect mt-2">
                ...
                <div class="row">
                    <div class="col-sm-6 pr-1 size-smtr">
                        ...
                        ?>
                        <a class="<?= $shortlist_class ?>" id="shortlist_a_<?= $get_member[0]->member_id ?>" <?php
                                                                                                                if ($shortlist_onclick == 1) { ?>onclick="return do_shortlist(<?= $get_member[0]->member_id ?>)" <?php } elseif ($shortlist_onclick == 0) { ?>onclick="return remove_shortlist(<?= $get_member[0]->member_id ?>)" <?php } ?>>
                    ...
                    <div class="col-sm-6 pl-1 size-smtl">
                        ...
                        ?>
                        <a class="<?= $followed_class ?>" id="followed_a_<?= $get_member[0]->member_id ?>" <?php
                                                                                                            if ($followed_onclick == 1) { ?>onclick="return do_follow(<?= $get_member[0]->member_id ?>)" <?php } elseif ($followed_onclick == 0) { ?>onclick="return do_unfollow(<?= $get_member[0]->member_id ?>)" <?php } ?>>
                ...
                <div class="row mt-2">
                    <div class="col-sm-6 pr-1 size-smr">
                        ...
                        <a class="<?= $report_class ?>" id="report_a_<?= $get_member[0]->member_id ?>" <?php
                                                                                                        if ($report_type == 1) { ?>onclick="return do_report(<?= $get_member[0]->member_id ?>)" <?php } elseif ($report_type == 0) { ?>onclick="return is_reported(<?= $get_member[0]->member_id ?>)" <?php } ?>>
                            <span id="report_text">
        ...
        <div class="profile-stats clearfix mt-2">
            <div class="stats-entry">
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('age'); ?></span>
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('mother_tongue'); ?></span>
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('religion'); ?></span>
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('caste_/_sect'); ?></span>
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('height'); ?></span>
                <span class="stats-label text-uppercase text-start pl-2"><?php echo translate('location'); ?></span>
            </div>

            <div class="stats-entry">
                <span class="stats-label text-uppercase text-start pl-2"> <?= $calculated_age = (date('Y') - date('Y', $get_member[0]->date_of_birth)); ?>&nbsp</span>
                <span class="stats-label text-uppercase text-start pl-2"><?= $this->Crud_model->get_type_name_by_id('language', $language_data[0]['mother_tongue']); ?>&nbsp</span>
                <span class="stats-label text-uppercase text-start pl-2"><?= $this->Crud_model->get_type_name_by_id('religion', $spiritual_and_social_background_data[0]['religion']); ?>&nbsp</span>
                <span class="stats-label text-uppercase text-start pl-2">
                    <?php
                    ...
                    ?>
                    &nbsp</span>
                <span class="stats-label text-uppercase text-start pl-2"><?= $get_member[0]->height . " " . translate('feet') ?>&nbsp</span>
                <span class="stats-label text-uppercase text-start pl-2"><?php if ($present_address_data[0]['country']) {
                                                                                echo $this->Crud_model->get_type_name_by_id('state', $present_address_data[0]['state']) . ', ' . $this->Crud_model->get_type_name_by_id('country', $present_address_data[0]['country']);
                                                                            } ?>&nbsp</span>
            </div>
        </div>
