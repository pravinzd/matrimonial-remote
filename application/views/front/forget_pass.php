...
<body>
    ...
    <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?= base_url() ?>uploads/login_image/<?= $login_image_data[0]['image'] ?>); background-position: center bottom;">
                    ...
                    <div class="form-card form-card--style-2 z-depth-3-top">
                        <div class="form-body">
                            ...
                            <form class="form-default" role="form" method="post" action="<?= base_url() ?>home/forget_pass/forget">
                                ...
                                <button type="submit" class="btn btn-styled btn-sm btn-block btn-base-1 z-depth-2-bottom mt-4 w-100"><?php echo translate('submit') ?></button>
                                <div class="row pt-3">
                                    <div class="col-12 text-center">
                                        <a class="c-gray-light text-underline" href="<?= base_url() ?>home/login">Log In Page</a>
                                    </div>
                                </div>
                            </form>
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <span class="c-gray-light"><?php echo translate('new_here?') ?></span><a class="c-gray-light text-underline " href="<?= base_url() ?>home/registration"> <?php echo translate('create_an_account_from_here!') ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
