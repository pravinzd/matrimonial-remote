...
<body>
    ...
    ?>
    <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?= base_url() ?>uploads/registration_image/<?= $registration_image_data[0]['image'] ?>); background-position: center bottom;">
        <span class="mask mask-dark--style-2"></span>
        <div class="container position-relative">
            <div class="row cols-xs-space align-items-center   ">
                        ...
                        <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="first_name" value="<?php if (!empty($form_contents)) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="last_name" value="<?php if (!empty($form_contents)) {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control form-control-sm" name="email" value="<?php if (!empty($form_contents)) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control form-control-sm" name="date_of_birth" value="<?php if (!empty($form_contents)) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-sm" name="mobile" value="<?php if (!empty($form_contents)) {
                            ...
                            <div class="row pt-3">
                                <div class="col-12 text-center">
                                    <a class="c-gray-light btn btn-sm btn-danger" href="<?= base_url() ?>home/login" class=""><?php echo translate('log_in_page') ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
