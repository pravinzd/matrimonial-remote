            ...
            <div class="profile-grid container-fluid profile-list-group mb-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('hobby') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $hobbies_and_interest_data[0]['hobby'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('interest') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('music') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $hobbies_and_interest_data[0]['music'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('books') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('movie') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $hobbies_and_interest_data[0]['movie'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('TV_show') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('sports_show') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $hobbies_and_interest_data[0]['sports_show'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('fitness_activity') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('cuisine') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $hobbies_and_interest_data[0]['cuisine'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('dress_style') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
