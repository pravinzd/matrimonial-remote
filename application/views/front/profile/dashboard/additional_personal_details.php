            ...
            <div class="profile-grid container-fluid profile-list-group mb-3">
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('home_district') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $additional_personal_details_data[0]['home_district'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('family_residence') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate("father's_occupation") ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $additional_personal_details_data[0]['fathers_occupation'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('special_circumstances') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
