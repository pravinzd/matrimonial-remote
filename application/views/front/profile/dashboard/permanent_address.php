            ...
            <div class="profile-grid container-fluid profile-list-group mb-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('country') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $this->Crud_model->get_type_name_by_id('country', $permanent_address_data[0]['permanent_country']); ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('state') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('city') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $this->Crud_model->get_type_name_by_id('city', $permanent_address_data[0]['permanent_city']); ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('postal-Code') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
