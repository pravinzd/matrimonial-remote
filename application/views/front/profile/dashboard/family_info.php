            ...
            <div class="profile-grid container-fluid profile-list-group mb-3">                    
                        <div class="row profile-list-group-item g-0">
                            <div class="col-6 col-lg-6">
                                <span  class="td-label"><?php echo translate('father') ?></span>
                            </div>
                            <div class="col-6 col-lg-6">
                                <?= $family_info_data[0]['father'] ?>
                            </div>
                            <div class="col-6 col-lg-6">
                                <span  class="td-label"><?php echo translate('mother') ?></span>
                            </div>
                            <div class="col-6 col-lg-6">
                        ...
                        <div class="row profile-list-group-item g-0">
                            <div class="col-6 col-lg-6">
                                <span  class="td-label"><?php echo translate('brother_/_sister') ?></span>
                            </div>
                            <div class="col-6 col-lg-6">
