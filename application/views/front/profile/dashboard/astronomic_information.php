            ...
            <div class="profile-grid container-fluid profile-list-group mb-3">
                        ...
                        <div class="row profile-list-group-item g-0">
                            <div class="col-6 col-lg-3">
                                <span  class="td-label"><?php echo translate('sun_sign')?></span>
                            </div>
                            <div class="col-6 col-lg-3">
                                <?=$astronomic_information_data[0]['sun_sign']?>
                            </div>
                            <div class="col-6 col-lg-3">
                                <span  class="td-label"><?php echo translate('moon_sign')?></span>
                            </div>
                            <div class="col-6 col-lg-3">
                        ...
                        <div class="row profile-list-group-item g-0">
                           <div class="col-6 col-lg-3">
                                <spa  class="td-label"n><?php echo translate('city_of_birth')?></span>
                            </div>
                            <div class="col-6 col-lg-3">
                                <?=$astronomic_information_data[0]['city_of_birth']?>
                            </div>
                            <div class="col-6 col-lg-3">
                                <span  class="td-label"><?php echo translate('time_of_birth')?></span>
                            </div>
                            <div class="col-6 col-lg-3">
