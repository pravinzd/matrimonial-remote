            ...
            <div class="profile-grid container-fluid profile-list-group  mb-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('first_name') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $get_member[0]->first_name ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('last_name') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('gender') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $this->Crud_model->get_type_name_by_id('gender', $get_member[0]->gender) ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('date_of_birth') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('number_of_children') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $basic_info_data[0]['number_of_children'] ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('area') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                ...
                <div class="row profile-list-group-item g-0">
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('on_behalf') ?></span>
                    </div>
                    <div class="col-6 col-lg-3">
                        <?= $this->Crud_model->get_type_name_by_id('on_behalf', $basic_info_data[0]['on_behalf']); ?>
                    </div>
                    <div class="col-6 col-lg-3">
                        <span class="td-label"><?php echo translate('mobile') ?></span>
                    </div>
                    <div class="col-6 col-lg-3"><?= $get_member[0]->mobile ?></div>
                </div>
                <div class="row profile-list-group-item g-0">

                    <div class="col-6 col-lg-6">
                        <span class="td-label">Parents Mobile</span>
                    </div>
                    <div class="col-6 col-lg-6"><?= $get_member[0]->mobile ?></div>
                </div>
                <div class="row profile-list-group-item g-0">

                    <div class="col col-lg-3">
                        <span class="td-label"><?php echo translate('email') ?></span>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="tel" class="form-control no-resize" name="mobile" value="<?= $get_member[0]->mobile ?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group ">
                        <label for="homemobile" class="text-uppercase c-gray-light">Parent's Number</label>

                        <input type="tel" class="form-control no-resize" name="homemobile">
