                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="date" class="form-control no-resize" name="date_of_birth" value="<?php if (!empty($form_contents)) {
                                                                                                                                                ...
                                                                                                                                                echo date('Y-m-d', $member->date_of_birth);
                                                                                                                                            } ?>">
                                                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                            <div class="help-block with-errors">
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="number" class="form-control no-resize" name="number_of_children" value="<?php if (!empty($form_contents)) {
                                                                                                                                                        ...
                                                                                                                                                        echo $basic_info_data[0]['number_of_children'];
                                                                                                                                                    } ?>" min="0">
                                                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                            <div class="help-block with-errors">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="body_art" value="<?php if (!empty($form_contents)) {
                                                                                                                                                ...
                                                                                                                                                echo $physical_attributes_data[0]['body_art'];
                                                                                                                                            } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="brother_sister" value="<?php if (!empty($form_contents)) {
                                                                                                                                                    ...
                                                                                                                                                    echo $family_info_data[0]['brother_sister'];
                                                                                                                                                } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="general_requirement" value="<?php if (!empty($form_contents)) {
                                                                                                                                                        ...
                                                                                                                                                        echo $partner_expectation_data[0]['general_requirement'];
                                                                                                                                                    } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_education" value="<?php if (!empty($form_contents)) {
                                                                                                                                                        ...
                                                                                                                                                        echo $partner_expectation_data[0]['partner_education'];
                                                                                                                                                    } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_profession" value="<?php if (!empty($form_contents)) {
                                                                                                                                                        ...
                                                                                                                                                        echo $partner_expectation_data[0]['partner_profession'];
                                                                                                                                                    } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_diet" value="<?php if (!empty($form_contents)) {
                                                                                                                                                    ...
                                                                                                                                                    echo $partner_expectation_data[0]['partner_diet'];
                                                                                                                                                } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_personal_value" value="<?php if (!empty($form_contents)) {
                                                                                                                                                            ...
                                                                                                                                                            echo $partner_expectation_data[0]['partner_personal_value'];
                                                                                                                                                        } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_family_value" value="<?php if (!empty($form_contents)) {
                                                                                                                                                            ...
                                                                                                                                                            echo $partner_expectation_data[0]['partner_family_value'];
                                                                                                                                                        } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="prefered_status" value="<?php if (!empty($form_contents)) {
                                                                                                                                                    ...
                                                                                                                                                    echo $partner_expectation_data[0]['prefered_status'];
                                                                                                                                                } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control no-resize" name="partner_complexion" value="<?php if (!empty($form_contents)) {
                                                                                                                                                        ...
                                                                                                                                                        echo $partner_expectation_data[0]['partner_complexion'];
                                                                                                                                                    } ?>">
                                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                                <div class="help-block with-errors">
                                                                </div>
