    ...
    <div class="card-body">
        ...
        ?>
                <div class="mb-4">
                    ...
                    ?>
                    <a class="c-base-1" href="<?php if ($is_approved == '1') {
                                                    echo base_url() ?>home/stories/story_detail/<?= $value->posted_by;
                                                                                            } else {
                                                                                                echo '#';
                                                                                            } ?>">
                        ...
                        <div class="swiper-wrapper" style="transition-duration: 0ms;">
                            ...
                            foreach ($images as $image) : ?>
                                <div class="swiper-slide <?php if ($i == 0) {
                                                            ...
                                                            } ?>" data-swiper-autoplay="5000" style="width: 100%; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
            ...
            <form class="form-default col-12" id="happy_story_form" method="post" action="<?= base_url() ?>home/stories/add" role="form" enctype="multipart/form-data">
                <div class="form-group has-feedback col-10 ms-auto  me-auto">
                ...
                <div class="form-group has-feedback col-10 ms-auto  me-auto text-center">
