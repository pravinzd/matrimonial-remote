<div class="card-title">
	<h3 class="heading heading-6 strong-500">
		<b><?php echo translate('picture_privacy_settings') ?></b>
	</h3>
</div>
<?php
				...
				<div class="form-group has-feedback">
					...
					<select class="form-control" name="profile_pic_show">
						...
						<option value="all" <?php if ($pic_privacy_data[0]['profile_pic_show'] == 'all') {
												echo "selected";
											} ?> class="form-control"><?php echo translate('all_member') ?></option>
						<option value="premium" <?php if ($pic_privacy_data[0]['profile_pic_show'] == 'premium') {
													echo "selected";
												} ?> class="form-control"><?php echo translate('premium_member') ?></option>
					</select>
