<div class="card-title">
    <h3 class="heading heading-6 strong-500">
        <b><?php echo translate('upload_your_image') ?></b>
    </h3>
</div>
<div class="card-body">
    <form class="form-default col-12" id="gallery_upload_form" method="post" action="<?= base_url() ?>home/gallery_upload/add" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group has-feedback col-10 ms-auto  me-auto select_div" id="img_main">
        ...
        <div class="form-group has-feedback col-10 ms-auto  me-auto text-center mt-5">
